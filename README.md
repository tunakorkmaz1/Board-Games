...
Originally completed as a group project for a statistics / data science course (Spring 2025)

## Project Summary
This project applies **statistical modeling and exploratory data analysis** to predict average
...
The final model explains **~66% of the variance (Adjusted R² = 0.657)**, balancing predictive
performance with interpretability — a key goal in applied data science.
...
- Identified skewed variables and applied **log transformations**
